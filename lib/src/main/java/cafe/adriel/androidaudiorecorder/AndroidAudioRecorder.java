...
public class AndroidAudioRecorder {
    ...
    protected static final String EXTRA_API_TOKEN = "apiToken";
    protected static final String EXTRA_API_SESSION_ID = "apiSession";
    ...
    public AndroidAudioRecorder setApiToken(String apiToken) {
        this.apiToken = apiToken;
        return this;
    }

    public AndroidAudioRecorder setSessionID(String recrodID) {
        this.sessionID = recrodID;
        return this;
    }
